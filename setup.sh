...
read SERVER_NAME
echo -n "Enter $SERVER_NAME address: "
read SERVER_ADDRESS
echo -n "Enter $SERVER_ADDRESS port: "
read SERVER_PORT
...
echo "SERVER_ADDRESS=$SERVER_ADDRESS" >> .credentials
echo "SERVER_PORT=$SERVER_PORT"       >> .credentials
